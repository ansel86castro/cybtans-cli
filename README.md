...
```
## GRPC Integration
You can use the cybtans-cli with the google protobuf compiler in order to generate messages from your .NET assemblies and mapping code. For example you can add the following to the `cybtans.json`
...
In addition the cybtans-cli allows you to generate REST proxies for your Grpc services.
